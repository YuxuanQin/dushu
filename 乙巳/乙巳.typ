...
如是网络文章，则可点击红色标题直达。本文用汉历纪日，以#link("https://pmo.cas.cn/xwdt2019/kpdt2019/202203/P020241223526694003756.pdf")[《日历资料》]为唯一标准。
#pagebreak()
...
/ hegemony: the control of some fucking powerful things 霸权, eg. the US hegemony
...
== 十六：樊明方《1911 -- 1921 年的外蒙古》
酣畅淋漓，笔记俱在蒙古史笔记中。

== 立春：英语、蒙古
=== 1. 剑桥雅思 20
/ contraption: A contraption is a device that has a specific purpose and is often overly complicated. 复杂器械
/ glowing: If something is glowing, it's either lit up like a light or it's full of praise and enthusiasm. So, you could receive a glowing candle or a glowing report card. You choose.
  - Also verb *glow*: To glow is to shine with light. On a clear night when the moon is full, it glows in the sky.
/ heckle: To heckle is to challenge or harass someone. At a sporting event, fans sometimes heckle the opposing team, but it’s not very respectable behavior. 诘问、起哄
/ pedant: `/ˈpɛdnt/` A pedant is an annoying person who is focused on minor details and book knowledge rather than ordinary common sense. In war, it can be dangerous to have a pedant as commander — he'll insist on textbook maneuvers instead of adapting to circumstances on the ground. 学究
/ referee: 裁判

=== 2. 周学军《哲布尊丹巴八世登极“额真汗”日期考》
哲布尊丹巴登极日期为公历 1911 年 12 月 29 日、汉历宣统三年十一月初十、俄历 1911 年 12 月 16 日、蒙历共戴元年十一月初九。

=== 2. _YOUNG MONGOLS AND VIGILANTES IN INNER MONGOLIA'S INTERREGNUM DECADES, 1911-1931_
"Young Mongol" 似乎是活跃于 1911 -- 1931 年的一个团体，汉文材料有田宓《“蒙古青年”与内蒙古自治运动》。

/ wither: If you forget to water your plants for six weeks, they'll wither -- they'll dry up and you probably won't be able to bring them back to life.
/ steppe: 草原
/ agitate: 骚动、煽动
/ proclivity: 癖好, eg. "He was indulging his own sexual proclivities."
/ consulate: 领事、领事馆
/ defiant: If you say that someone is defiant, you mean they show aggression or independence by refusing to obey someone. *a defiant attitude*.Also noun *defiance*
/ plateau: 高原
/ stymie: Sounds like "stai-mi". The verb stymie means "to obstruct or hinder." Constantly texting with your friends will stymie your effort to finish your homework.
/ languish: 憔悴、失去活力, eg. "Without the founder's drive and direction, the company gradually languished."
/ incessant: Something incessant continues without interruption. When you're on a cross-country flight, it's tough to tolerate the incessant crying of a baby. 无休止的, synonym *ceaseless*
/ coalition: A coalition is a group of people who join together for a common cause, like a coalition you form with other skateboarders who want to convince your town to build a skate park.

== 十九：#link("https://willcrichton.net/notes/portable-epubs/")[Portable EPUBs]
著者提出了一种“新”的文件格式——可塑 ePUB，看起来挺有意思的：结合了 pdf 的优点，同时不失 html 的好处。当然了，最值得一提的是著者为此做出的实在贡献：#link("nota-lang.org")[Nota 语言]，以及#link("https://github.com/nota-lang/bene")[ bene 阅读器]，后者看起来相当于 `pdf.js` 的 ePUB 版本。

== 二十：剑桥雅思 19
/ deficiency: 缺乏、不足, eg. "deficiency of oxygen 缺乏氧气"

== 廿三：#link("https://en.wikipedia.org/wiki/Pan-Mongolism")[_Pan-Mongolism_ (Wikipedia)]
/ annex: Sometimes annex is used as a nice word for "take" or "grab," as when Nazi Germany took the Sudetenland from Czechoslovakia in 1938 and added it to their own territory. In order to annex something to what is yours, you have to take it away from someone else. 吞并
/ condescend: 屈尊.
/ extort: To take or seize from an unwilling person by physical force, menace, duress, torture, or any undue or illegal exercise of power or ingenuity. eg. "extorting passing caravans" 勒索
/ inculcate: To inculcate is to teach through frequent instruction. If you repeatedly tell your brother how important it is to be responsible, then you’re trying to inculcate in him a sense of responsibility. 灌输
/ dilute: 稀释、冲淡,
...
/ imperative: When something absolutely has to be done and cannot be put off, use the adjective imperative. 必要的、紧急的
/ expertise: 专门技术
/ incentive: If your mom wants you to mow the lawn but you don't feel like it, she might offer to treat you to ice cream after as an incentive. An incentive is something that stimulates you to take action or work harder. 激励
...
/ blight: A blight is a disease that hurts plants and makes their leaves wither. It can also affect neighborhoods. Urban blight refers to a part of the city where things are falling apart. 使植物枯萎
...
/ contigent: The adjective contingent can be used to describe something that can occur only when something else happens first. Making money is contingent on finding a good-paying job. 必要结果
/ erratic: unpredictable
/ foe: enemy
/ limb: 四肢
/ nocturnal: 夜行的
/ stride: fucking significant progress
/ supersede: When something supersedes, it takes the place of something else. The 5th edition of your history textbook supersedes the 4th edition. 取代

=== 2. #link("https://en.wikipedia.org/wiki/Gungsangnorbu")[贡桑诺尔布（Wikipedia）]
/ thwart: $=$ hinder. A villain's worst nightmare is the superhero who always seems to thwart his efforts, preventing him from carrying out his plans to take over the world.

参考文献极有价值，已记录在蒙古史笔记中。

=== 廿五：英语、贡桑诺尔布
=== 1. 白拉都格其《辛亥革命与贡桑诺尔布》
=== 2. 《内蒙古文史资料选辑（第一辑）》之《贡桑诺尔布》

无甚可说，蠓畜耳。

=== 3. #link("https://hefengxian.github.io/my-ielts/#/vocabulary")[雅思词汇]
/ pigment: 颜料、色素
